...
ADD FOREIGN KEY (`ActionType`) REFERENCES `Application` (`ActionType`);
-- not done
ALTER TABLE `RegActionDate`
ADD FOREIGN KEY (`ApplNo`) REFERENCES `Application` (`ApplNo`);  
ALTER TABLE `RegActionDate`
ADD FOREIGN KEY (`DocType`) REFERENCES `DocType_lookup` (`DocType`);
...
ALTER TABLE `AppDoc`
ADD FOREIGN KEY (`DocType`) REFERENCES `AppDocType_Lookup` (`AppDocType`);
ALTER TABLE `AppDoc`
ADD FOREIGN KEY (`ActionType`) REFERENCES `RegActionDate` (`ActionType`);
ALTER TABLE `AppDoc`
ADD FOREIGN KEY (`SeqNo`) REFERENCES `RegActionDate` (`InDocTypeSeqNo`);
ALTER TABLE `AppDoc`
ADD FOREIGN KEY (`ApplNo`) REFERENCES `RegActionDate` (`ApplNo`);
ALTER TABLE `AppDoc`
ADD FOREIGN KEY (`DuplicateCounter`) REFERENCES `RegActionDate` (`DuplicateCounter`);
